...
@foreach($categories as $category)
  <tbody>
    <tr>
     ...
     <a class="btn btn-danger me-md-2" href="/category/delete/{{$category->id}}"><i class="fa-solid fa-trash-can"></i></a>
     <a class="btn btn-success me-md-2" href="/category/details/{{$category->id}}"><i class="fa-solid fa-pencil" aria-hidden="true"></i></a>
      </td>
    </tr>
@endforeach
